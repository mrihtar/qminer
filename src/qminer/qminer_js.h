...
#define JsDeclareFunction(Function) static void Function(const v8::FunctionCallbackInfo<v8::Value>& Args); \
	static void _ ## Function(const v8::FunctionCallbackInfo<v8::Value>& Args) { \
		...
		try { \
			...
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				isolate->ThrowException(Why); \
			} else { \
				throw Except; \
			} \
		} \
...
#define JsDeclareTemplatedFunction(Function) \
	static v8::Handle<v8::Value> _ ## Function(const v8::FunctionCallbackInfo<v8::Value>& Args) { \
		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandleScope HandleScope(isolate); \
		try { \
			return HandleScope.Escape(Function(Args)); \
		} catch(PExcept Except) { \
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				v8::ThrowException(Why); \
				return HandleScope.Escape(v8::Undefined()); \
			} else { \
				throw Except; \
			} \
		} \
	} \
	static v8::Handle<v8::Value> Function(const v8::FunctionCallbackInfo<v8::Value>& Args) { throw TQmExcept::New("Not implemented!"); }
	
// Property declaration and registration 
#define JsRegisterProperty(Template, Function) \
	Template->SetAccessor(v8::String::NewFromUtf8(isolate, #Function), _ ## Function);
#define JsLongRegisterProperty(Template, JsFunction, CppFunction) \
	Template->SetAccessor(v8::String::NewFromUtf8(isolate, JsFunction), _ ## CppFunction);
#define JsDeclareProperty(Function) \
	...
	static v8::Handle<v8::Value> _ ## Function(v8::Local<v8::String> Properties, const v8::AccessorInfo& Info) { \
		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandlescope HandleScope(isolate); \
		try { \
			return HandleScope.Escape(Function(Properties, Info)); \
		} catch(PExcept Except) { \
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				v8::ThrowException(Why); \
...
#define JsRegisterSetProperty(Template, JsFunction, GetCppFunction, SetCppFunction) \
	Template->SetAccessor(v8::String::NewFromUtf8(isolate, JsFunction), _ ## GetCppFunction, _ ## SetCppFunction);
#define JsDeclareSetProperty(GetFunction, SetFunction) \
	...
	static v8::Handle<v8::Value> _ ## GetFunction(v8::Local<v8::String> Properties, const v8::AccessorInfo& Info) { \
		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandlescope HandleScope(isolate); \
		try { \
			return HandleScope.Escape(GetFunction(Properties, Info)); \
		} catch(PExcept Except) { \
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				v8::ThrowException(Why); \
...
#define JsDeclIndexedProperty(Function) \
	...
	static v8::Handle<v8::Value> _ ## Function(uint32_t Index, const v8::AccessorInfo& Info) { \
		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandleScope HandleScope(isolate); \
		try { \
			return HandleScope.Escape(Function(Index, Info)); \
		} catch(PExcept Except) { \
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				v8::ThrowException(Why); \
...
#define JsDeclGetSetIndexedProperty(FunctionGetter, FunctionSetter) \
	...
	static v8::Handle<v8::Value> _ ## FunctionGetter(uint32_t Index, const v8::AccessorInfo& Info) { \
		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandleScope HandleScope(isolate); \
		try { \
			return HandleScope.Escape(FunctionGetter(Index, Info)); \
		} catch(PExcept Except) { \
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				v8::ThrowException(Why); \
	...
	static v8::Handle<v8::Value> _ ## FunctionSetter(uint32_t Index, v8::Local<v8::Value> Value, const v8::AccessorInfo& Info) { \
		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandlescope HandleScope(isolate); \
		try { \
			return HandleScope.Escape(FunctionSetter(Index, Value, Info)); \
		} catch(PExcept Except) { \
			if(typeid(Except) == typeid(TQmExcept::New(""))) { \
				v8::Handle<v8::Value> Why = v8::String::NewFromUtf8(isolate, Except->GetMsgStr().CStr()); \
				v8::ThrowException(Why); \
...
private:
	...
	// json parsing
	static v8::Persistent<v8::Context, v8::CopyablePersistentTraits<v8::Context>> TJsUtil::ParseContext;
	static v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function>> JsonParser;
	static v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function>> JsonString;
...
public:
	...
	// TODO make this work :)
	/*template<class T>
	static v8::Local<T> ToLocal(v8::Isolate* isolate, v8::Persistent<T> pers) {
		v8::Local<T> obj;
		if (pers.IsWeak())
			obj = v8::Local<T>::New(isolate, pers); 
		else
			obj = *reinterpret_cast<v8::Local<T>*>(&pers);
		return obj;
	}*/
...
private: 
	...
	THash<TInt, v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > > JsNmFunH;;
...
public:
	...
	void Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun);
	/// Execute JavaScript callback in this script's context
	void Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const v8::Handle<v8::Value>& Arg);
	/// Execute JavaScript callback in this script's context
	void Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal);
	/// Execute JavaScript callback in this script's context
	void Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal, v8::Handle<v8::Object>& V8Obj);
	/// Execute JavaScript callback in this script's context
	void Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, v8::Handle<v8::Object>& Arg1, v8::Handle<v8::Object>& Arg2);
	/// Execute JavaScript callback in this script's context
	v8::Handle<v8::Value> ExecuteV8(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal);
	/// Execute JavaScript callback in this script's context
	bool ExecuteBool(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const v8::Handle<v8::Object>& Arg);
	/// Execute JavaScript callback in this script's context
	bool ExecuteBool(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const v8::Handle<v8::Object>& Arg1,
        const v8::Handle<v8::Object>& Arg2);
	/// Execute JavaScript callback in this script's context
	TStr ExecuteStr(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal);
	/// Execute JavaScript callback in this script's context
	void Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const TStr& Str);
	/// Execute JavaScript callback in this script's context
	TStr ExecuteStr(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const TStr& Str);

	/// Add new server function
	void AddSrvFun(const TStr& ScriptNm, const TStr& FunNm, const TStr& Verb, const v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> >& JsFun);
...
//		v8::Handle<v8::Value> Val = Global->Get(v8::String::NewFromUtf8(isolate, ProtoPathV[0].CStr()));
//		v8::Handle<v8::Object> Obj = v8::Handle<v8::Object>::Cast(Val);
//		for (int ObjN = 1; ObjN < ProtoPathV.Len(); ObjN++) {
//			Val = Obj->Get(v8::String::NewFromUtf8(isolate, ProtoPathV[ObjN].CStr()));
...
//	static TJsObj* GetSelf(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//	static TStr GetFunNm(const v8::FunctionCallbackInfo<v8::Value>& Args) {
...
//	static bool IsArg(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
...
//	static TJsObj* GetArgObj(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//		v8::Handle<v8::Value> Val = Args[ArgN];
//    	v8::Handle<v8::Object> Data = v8::Handle<v8::Object>::Cast(Val);	
...
//	static TStr GetArgJsonStr(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//		QmAssertR(Args.Length() > ArgN, TStr::Fmt("Missing argument %d", ArgN));
//		v8::Handle<v8::Value> Val = Args[ArgN];
...
//	static v8::Persistent<v8::Function> GetArgFunPer(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//		v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//		QmAssertR(Args.Length() > ArgN, TStr::Fmt("Missing argument %d", ArgN));
//		v8::Handle<v8::Value> Val = Args[ArgN];
//		QmAssertR(Val->IsFunction(), TStr::Fmt("Argument %d expected to be function", ArgN));
...
private:
	...
	TBool JsonP;
	/// on success callback
	v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > OnSuccessFun; 
	/// on error callback
	v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > OnErrorFun;

public:
	TJsFetchRq() { }
	/// new request with javascript callbacks
	TJsFetchRq(const PHttpRq& _HttpRq, const bool& _JsonP, 
		const v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> >& _OnSuccessFun,
		const v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> >& _OnErrorFun) :
	...
	v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > GetOnSuccess() const { return OnSuccessFun; }
	/// IS there on success callback
	bool IsOnError() const { return !OnErrorFun.IsEmpty(); }
	/// Get on success callback
	v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > GetOnError() const { return OnErrorFun; }
};
...
//	static PRecSet GetArgRecSet(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN);
//	~TJsRecSet() { }
//
//	// template
//	static v8::Handle<v8::ObjectTemplate> GetTemplate();
...
//    static TRec GetArgRec(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN);
//
//	~TJsRec() { }
//
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::at(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::put(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsVecUtil::GetSelf(Args);
//	if (Args.Length() == 2) {
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::push(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsVecUtil::GetSelf(Args);	
//	// assume number
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::sum(const v8::FunctionCallbackInfo<v8::Value>& Args) {
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::getMaxIdx(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	// currently only float vectors are supported
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsObjUtil<TJsVec>::GetSelf(Args);
//	double Val = TFlt::Mn;
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::sort(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsObjUtil<TJsVec>::GetSelf(Args);
//	bool Asc = true;
//	if (Args.Length() > 0) {
...
//
//template <class TVal, class TAux>
//v8::Handle<v8::Value> TJsVec<TVal, TAux>::print(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//    static PFtrSpace GetArgFtrSpace(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN);
//
//	static v8::Handle<v8::ObjectTemplate> GetTemplate();
//
//	//# 
...
//    /// Are we allowed to access given path
//	static bool CanAccess(const v8::FunctionCallbackInfo<v8::Value>& Args);
//
//    //# 
//	//# **Functions and properties:**
//	//#     
