...
void TJsUtil::Init() {
	if (!InitP) {
		...
		v8::Handle<v8::String> GuidV8Str = v8::String::NewFromUtf8(isolate, GuidStr.CStr());

		// context for parsing
		v8::Local<v8::Context> Context = v8::Context::New(isolate);
		Context->SetSecurityToken(GuidV8Str);
		ParseContext = v8::Persistent<v8::Context, v8::CopyablePersistentTraits<v8::Context>>::Persistent(isolate, Context);
		// json parsers
		JsonParser.Reset();
		JsonString.Reset();
		v8::Context::Scope ContextScope(Context);
		v8::Handle<v8::Object> Json = Context->Global()->Get(v8::String::NewFromUtf8(isolate, "JSON"))->ToObject();
		v8::Handle<v8::Function> parseFunc = v8::Handle<v8::Function>::Cast(Json->Get(v8::String::NewFromUtf8(isolate, "parse")));
		JsonParser = v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function>>::Persistent(isolate, parseFunc);
		v8::Handle<v8::Function> stringFunc = v8::Handle<v8::Function>::Cast(Json->Get(v8::String::NewFromUtf8(isolate, "stringify")));
		JsonParser = v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function>>::Persistent(isolate, stringFunc);
		InitP = true;
	}
}
v8::Persistent<v8::Context, v8::CopyablePersistentTraits<v8::Context>> TJsUtil::ParseContext;
v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function>> TJsUtil::JsonParser;
v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function>> TJsUtil::JsonString;
	...
	if (ErrTrace.length() > 0 && !TryCatch.StackTrace()->IsUndefined()) {
		...
		if (Except->IsString()) {
			...
			throw TQmExcept::New(TStr::Fmt("%s", *ErrStr));
				  ...
				  !(Except->ToObject()->Get(v8::String::NewFromUtf8(isolate, "message"))->IsUndefined()) &&
				  !(Except->ToObject()->Get(v8::String::NewFromUtf8(isolate, "name"))->IsUndefined())) {
			v8::String::Utf8Value Name(Except->ToObject()->Get(v8::String::NewFromUtf8(isolate, "name")));
			v8::String::Utf8Value ErrMsg(Except->ToObject()->Get(v8::String::NewFromUtf8(isolate, "message")));
...
v8::Handle<v8::Value> TJsUtil::ParseJson(const TStr& JsonStr) {
	...
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandleScope HandleScope(isolate);
	v8::Local<v8::Context> LocalParseContext = v8::Local<v8::Context>::New(isolate, ParseContext);
	v8::Context::Scope ContextScope(LocalParseContext);
	v8::Handle<v8::Value> JsonV8Str = v8::String::NewFromUtf8(isolate, JsonStr.CStr());
	v8::TryCatch TryCatch;
	v8::Local<v8::Function> LocalJsonParser = v8::Local<v8::Function>::New(isolate, JsonParser);
	v8::Local<v8::Value> Value = LocalJsonParser->Call(LocalParseContext->Global(), 1, &JsonV8Str);
	if (Value.IsEmpty()) { return HandleScope.Escape(TryCatch.Exception()); }
...
v8::Handle<v8::Value> TJsUtil::V8JsonToV8Str(v8::Handle<v8::Value> Json) {
	...
	v8::Context::Scope ContextScope(LocalParseContext);
	v8::TryCatch TryCatch;
	v8::Local<v8::Function> LocalJsonString = v8::Local<v8::Function>::New(isolate, JsonString);
	v8::Local<v8::Value> JsonStr = LocalJsonString->Call(LocalParseContext->Global(), 1, &Json);
	if (JsonStr.IsEmpty()) { return HandleScope.Escape(TryCatch.Exception()); }
...
v8::Handle<v8::Value> TJsUtil::GetV8Date(const TTm& Tm) {
	...
	v8::Local<v8::Value> Date = v8::Date::New(isolate, MSecs);
	return HandleScope.Escape(Date);
}

TTm TJsUtil::GetGlibDate(v8::Handle<v8::Value> Date) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
v8::Handle<v8::Object> TJsUtil::HttpRqToJson(PHttpRq HttpRq) {
    ...
    for (int FieldN = 0; FieldN < HttpRq->GetFldValH().Len(); FieldN++) {
        ...
        Request->Set(v8::String::NewFromUtf8(isolate, KeyVal.CStr()), v8::String::NewFromUtf8(isolate, HttpRq->GetFldValH().GetDat(KeyVal).CStr()));
    }
    // Method
    Request->Set(v8::String::NewFromUtf8(isolate, "method"), v8::String::NewFromUtf8(isolate, HttpRq->GetMethodNm().CStr()));
    // URL
    // - scheme
    Request->Set(v8::String::NewFromUtf8(isolate, "scheme"), v8::String::NewFromUtf8(isolate, HttpRq->GetUrl()->GetSchemeNm().CStr()));
    // - path
    Request->Set(v8::String::NewFromUtf8(isolate, "path"), v8::String::NewFromUtf8(isolate, HttpRq->GetUrl()->GetPathStr().CStr()));
    // GET arguments
    ...
    for (int KeyN = 0; KeyN < HttpRq->GetUrlEnv()->GetKeys(); KeyN++) {
        ...
        v8::Handle<v8::Array> ArgVals = v8::Array::New(isolate, HttpRq->GetUrlEnv()->GetVals(ArgKey));
        for (int ValN = 0; ValN < HttpRq->GetUrlEnv()->GetVals(ArgKey); ValN++) {
            ArgVals->Set(ValN, v8::String::NewFromUtf8(isolate, HttpRq->GetUrlEnv()->GetVal(ArgKey, ValN).CStr()));
        }
        Args->Set(v8::String::NewFromUtf8(isolate, ArgKey.CStr()), ArgVals);
    }
    Request->Set(v8::String::NewFromUtf8(isolate, "args"), Args);
    // Request Body
    // - raw data
    TStr Data;
    if (HttpRq->IsBody()) {
        ...
        if (HttpRq->IsContType(THttp::AppJSonFldVal)) {
            ...
            Request->Set(v8::String::NewFromUtf8(isolate, "jsonData"), BodyVal);
        }
    }
    Request->Set(v8::String::NewFromUtf8(isolate, "data"), v8::String::NewFromUtf8(isolate, Data.CStr()));
	return HandleScope.Escape(Request); 
    //return Request;
}
...
TScript::~TScript() {
	...
	JsFetch.Del();
	// remove context
	//Context.Dispose(); // TODO CHECK IF OK !!!! JAN RUPNIK
...
void TScript::Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
    v8::Local<v8::Context> LContext = v8::Local<v8::Context>::New(isolate, Context);
	v8::Local<v8::Function> LFun = v8::Local<v8::Function>::New(isolate, Fun);
	LFun->Call(LContext->Global(), 0, NULL);
	TJsUtil::HandleTryCatch(TryCatch);
}

void TScript::Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const v8::Handle<v8::Value>& Arg) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1; v8::Handle<v8::Value> Argv[Argc] = { Arg };
	v8::Local<v8::Context> LContext = v8::Local<v8::Context>::New(isolate, Context);
	v8::Local<v8::Function> LFun = v8::Local<v8::Function>::New(isolate, Fun);
	LFun->Call(LContext->Global(), Argc, Argv);
	TJsUtil::HandleTryCatch(TryCatch);
}

void TScript::Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1;
...
void TScript::Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& Arg1, v8::Handle<v8::Object>& Arg2) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 2;
...
void TScript::Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, v8::Handle<v8::Object>&  Arg1, v8::Handle<v8::Object>& Arg2) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 2;
...
v8::Handle<v8::Value> TScript::ExecuteV8(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1;
	v8::Handle<v8::Value> Argv[Argc] = { TJsUtil::ParseJson(JsonVal) };
	v8::Local<v8::Context> LContext = v8::Local<v8::Context>::New(isolate, Context);
	v8::Local<v8::Function> LFun = v8::Local<v8::Function>::New(isolate, Fun); 
	v8::Local<v8::Value> RetVal = LFun->Call(LContext->Global(), Argc, Argv);
	// handle errors
	TJsUtil::HandleTryCatch(TryCatch);
    return HandleScope.Escape(RetVal);
}

bool TScript::ExecuteBool(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const v8::Handle<v8::Object>& Arg) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1;
...
bool TScript::ExecuteBool(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, 
...
TStr TScript::ExecuteStr(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const PJsonVal& JsonVal) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1;
	v8::Handle<v8::Value> Argv[Argc] = { TJsUtil::ParseJson(JsonVal) };
...
void TScript::Execute(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const TStr& Str) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1;
	v8::Handle<v8::Value> Argv[Argc] = { v8::String::NewFromUtf8(isolate, Str.CStr()) };
	v8::Local<v8::Context> LContext = v8::Local<v8::Context>::New(isolate, Context);
	v8::Local<v8::Function> LFun = v8::Local<v8::Function>::New(isolate, Fun);
	LFun->Call(LContext->Global(), Argc, Argv);
	TJsUtil::HandleTryCatch(TryCatch);
...
TStr TScript::ExecuteStr(v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > Fun, const TStr& Str) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
	v8::TryCatch TryCatch;
	const int Argc = 1;
	v8::Handle<v8::Value> Argv[Argc] = { v8::String::NewFromUtf8(isolate, Str.CStr()) };
...
void TScript::AddSrvFun(const TStr& ScriptNm, const TStr& FunNm, 
	const TStr& Verb, const v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> >& JsFun) {
...
void TScript::ExecuteSrvFun(const PHttpRq& HttpRq, const TWPt<TJsHttpResp>& JsHttpResp) {
    ...
    // Search the rules
    int SelectedRule = -1;
    v8::Handle<v8::Object> Params = v8::Object::New(isolate);
        ...
        for(int PathN = 0; PathN < Rule->GetArrVals(); PathN++) {
            if(Rule->GetArrVal(PathN)->GetObjStr("path") == Url->GetPathSeg(Seg)) {
                if(Rule->GetArrVal(PathN)->IsObjKey(("param"))) {
                    Seg++;
                    Params->Set(v8::String::NewFromUtf8(isolate, Rule->GetArrVal(PathN)->GetObjStr("param").CStr()),
                                v8::String::NewFromUtf8(isolate, Url->GetPathSeg(Seg).CStr()));
                }
                Seg++;
            }
            else {
    ...
    Request->Set(v8::String::NewFromUtf8(isolate, "params"), Params);
    // Exec
    if(RuleMatched && SelectedRule >= 0) {
        // get function
        v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > JsFun = JsNmFunH.GetDat(SelectedRule);
        // execute
        try {
            // UNCOMMENT JAN RUPNIK
...
void TScript::require(const v8::FunctionCallbackInfo<v8::Value>& Args) {
	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::EscapableHandleScope HandleScope(isolate);
    TStr ModuleFNm;
    try {
        ...
        v8::Handle<v8::Script> Module = v8::Script::Compile(
            v8::String::NewFromUtf8(isolate, ModuleSource.CStr()),
             v8::String::NewFromUtf8(isolate, ModuleFNm.CStr()));
        // execute the module
        Module->Run();
        // collect the result
        v8::Handle<v8::Function> ModuleFun = v8::Handle<v8::Function>::Cast(
            Context->Global()->Get(v8::String::NewFromUtf8(isolate, "module")));
        v8::Local<v8::Value> RetVal = ModuleFun->Call(Context->Global(), 0, NULL);
        // handle errors
        TJsUtil::HandleTryCatch(TryCatch);
        // return result
...
void TScript::Init() {
	...
	//// NEW API JAN RUPNIK LAST WAS HERE
    // create new context    
	Context.Reset();
	v8::Handle<v8::ObjectTemplate> GlobalTemp = v8::ObjectTemplate::New();	
    GlobalTemp->SetInternalFieldCount(1);	
	v8::Local<v8::Context> LContext = v8::Context::New(isolate, 0, GlobalTemp);
	// prepare security token
	SecurityToken = TGuid::GenGuid();
	v8::Handle<v8::String> SecurityTokenV8 = v8::String::NewFromUtf8(isolate, SecurityToken.CStr());
	LContext->SetSecurityToken(SecurityTokenV8);
	// get into the context scope
	v8::Context::Scope ContextScope(LContext);
    // add pointer to TScript to the global object
    v8::Handle<v8::Object>::Cast(LContext->Global()->GetPrototype())->SetInternalField(0, v8::External::New(isolate, this));
    // initialize module-loading system
    v8::Local<v8::Function> RequireFun = v8::FunctionTemplate::New(isolate, require)->GetFunction();
    LContext->Global()->Set(v8::String::NewFromUtf8(isolate, "require"), RequireFun);
	Context = v8::Persistent<v8::Context>::Persistent(isolate, LContext);
...
void TScript::Install() {
	...
	LContext->Global()->Delete(v8::String::NewFromUtf8(isolate, "console"));
	LContext->Global()->Delete(v8::String::NewFromUtf8(isolate, "qm"));
	LContext->Global()->Delete(v8::String::NewFromUtf8(isolate, "fs"));
	LContext->Global()->Delete(v8::String::NewFromUtf8(isolate, "http"));
	LContext->Global()->Delete(v8::String::NewFromUtf8(isolate, "la"));
	// create fresh ones
	// JAN RUPNIK UNCOMMENT
	//   DebugLog("Installing 'console' object");
	//LContext->Global()->Set(v8::String::NewFromUtf8(isolate, "console"), TJsConsole::New(this));
 //   DebugLog("Installing 'qm' object");
	//LContext->Global()->Set(v8::String::NewFromUtf8(isolate, "qm"), TJsBase::New(this));
 //   DebugLog("Installing 'fs' object");
	//LContext->Global()->Set(v8::String::NewFromUtf8(isolate, "fs"), TJsFs::New(this));
 //   DebugLog("Installing 'http' object");
	//LContext->Global()->Set(v8::String::NewFromUtf8(isolate, "http"), TJsHttp::New(this));
	//DebugLog("Installing 'la' object");
	//LContext->Global()->Set(v8::String::NewFromUtf8(isolate, "la"), TJsLinAlg::New(this));
}
...
void TScript::Execute(const TStr& FNm) {
    ...
    v8::Handle<v8::Script> Script = v8::Script::Compile(
        v8::String::NewFromUtf8(isolate, Source.CStr()), 
        v8::String::NewFromUtf8(isolate, FNm.GetFBase().CStr()));
...
void TJsSrvFun::Exec(const TStrKdV& FldNmValKdV, const PSAppSrvRqEnv& RqEnv) {
	...
	if (FunNm == "admin") {
    	...
    	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
		v8::Local<v8::Context> LContext = v8::Local<v8::Context>::New(isolate, Js->Context);
		v8::Context::Scope ContextScope(LContext);
		// JAN RUPNIK UNCOMMENT
...
//}
//	
//v8::Handle<v8::Value> TJsBase::op(const v8::FunctionCallbackInfo<v8::Value>& Args) {	
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsBase::store(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsBase* JsBase = TJsBaseUtil::GetSelf(Args);
...
//v8::Handle<v8::Value> TJsBase::getStoreList(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsBase* JsBase = TJsBaseUtil::GetSelf(Args);
//    TJsonValV StoreValV;
...
//
///// Create stores from the JS interface
//v8::Handle<v8::Value> TJsBase::createStore(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsBase* JsBase = TJsBaseUtil::GetSelf(Args);
//    // check we can write
...
//}
//
//v8::Handle<v8::Value> TJsBase::search(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsBase* JsBase = TJsBaseUtil::GetSelf(Args);
//	try {
...
//}
//
//v8::Handle<v8::Value> TJsBase::gc(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsBase* JsBase = TJsBaseUtil::GetSelf(Args);
//	try {
...
//	v8::Local<v8::String> StoreName = v8::String::NewFromUtf8(isolate, JsStore->Store->GetStoreNm().CStr());
...
//        Field->Set(v8::String::NewFromUtf8(isolate, "id"), v8::Int32::New(FieldDesc.GetFieldId()));
...
//        Field->Set(v8::String::NewFromUtf8(isolate, "nullable"), v8::Boolean::New(FieldDesc.IsNullable()));
//        Field->Set(v8::String::NewFromUtf8(isolate, "internal"), v8::Boolean::New(FieldDesc.IsInternal()));
//        Field->Set(v8::String::NewFromUtf8(isolate, "primary"), v8::Boolean::New(FieldDesc.IsPrimary()));
...
//        Join->Set(v8::String::NewFromUtf8(isolate, "id"), v8::Int32::New(JoinDesc.GetJoinId()));
...
//}
//
//v8::Handle<v8::Value> TJsStore::rec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsStore::add(const v8::FunctionCallbackInfo<v8::Value>& Args) {
...
//}
//
//v8::Handle<v8::Value> TJsStore::newRec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
//    PJsonVal RecVal = TJsStoreUtil::GetArgJson(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsStore::newRecSet(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
...
//}
//
//v8::Handle<v8::Value> TJsStore::sample(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsStore::field(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsStore::key(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsStore::addTrigger(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
//	// parse parameters
...
//}
//
//v8::Handle<v8::Value> TJsStore::addStreamAggr(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
//    // get parameter
...
//}
//
//v8::Handle<v8::Value> TJsStore::getStreamAggr(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsStore::getStreamAggrNames(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsStore* JsStore = TJsStoreUtil::GetSelf(Args);
//	TWPt<TBase> Base = JsStore->Js->Base;
//	const uint StoreId = JsStore->Store->GetStoreId();
...
//}
//
//PRecSet TJsRecSet::GetArgRecSet(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//    v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::clone(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::join(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::aggr(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
//	if (Args.Length() == 0) { 
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::trunc(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::sample(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::shuffle(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::reverse(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::sortById(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::sortByFq(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
//	const bool Asc = (TJsRecSetUtil::GetArgInt32(Args, 0, 0) > 0);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::sortByField(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::sort(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::filterById(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
//    if (Args.Length() == 1) {
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::filterByFq(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::filterByField(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
//    // get field
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::filter(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::deleteRecs(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsRecSet::toJSON(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsRecSet* JsRecSet = TJsRecSetUtil::GetSelf(Args);
//	const int MxHits = -1;
//	const int Offset = 0;
...
//}
//
//TRec TJsRec::GetArgRec(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) { 
//    v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we have the argument at all
//    AssertR(Args.Length() > ArgN, TStr::Fmt("Missing argument %d", ArgN));
//    v8::Handle<v8::Value> Val = Args[ArgN];
...
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, RecNm.CStr()));
//}
//
...
//		return HandleScope.Close(v8::String::NewFromUtf8(isolate, Val.CStr()));
//    } else if (Desc.IsStrV()) {
...
//}
//
//v8::Handle<v8::Value> TJsRec::addJoin(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsRec::delJoin(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    TJsRec* JsRec = TJsRecUtil::GetSelf(Args);
//    // read argument as record
//    TStr JoinNm = TJsRecUtil::GetArgStr(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsRec::toJSON(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    TJsRec* JsRec = TJsRecUtil::GetSelf(Args);
...
//v8::Handle<v8::Value> TJsHoeffdingTree::process(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//
//// NOTE: It is your responsibility to make sure the input line is a valid stream example 
//v8::Handle<v8::Value> TJsHoeffdingTree::classify(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsHoeffdingTree* JsHoeffdingTree = TJsHoeffdingTreeUtil::GetSelf(Args);
//	if(Args.Length() == 1 && Args[0]->IsString()) {
//		TStr Line = TJsHoeffdingTreeUtil::GetArgStr(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsHoeffdingTree::exportModel(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, StoreNm.CStr()));
//}
//
...
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, IndexKeyNm.CStr()));
//}
//
...
//		KeyValV8->Set(v8::Number::New(WordN), v8::String::NewFromUtf8(isolate, KeyValV[WordN].CStr()));		
//	}
...
//	v8::Local<v8::Array> KeyValV8 = v8::Array::New(KeyValV.Len());
//	for (int WordN = 0; WordN < KeyValV.Len(); WordN++) {		
//		KeyValV8->Set(v8::Number::New(WordN), v8::String::NewFromUtf8(isolate, KeyValV[WordN].Val2.GetStr().CStr()));		
//	}
//	return HandleScope.Close(KeyValV8);
//}
//
...
//}
//
//v8::Handle<v8::Value> TJsLinAlg::newVec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsLinAlg::newIntVec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsLinAlg* JsLinAlg = TJsLinAlgUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsLinAlg::newMat(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsLinAlg* JsLinAlg = TJsLinAlgUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsLinAlg::newSpVec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsLinAlg* JsLinAlg = TJsLinAlgUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsLinAlg::newSpMat(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsLinAlg* JsLinAlg = TJsLinAlgUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsLinAlg::svd(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsLinAlg* JsLinAlg = TJsLinAlgUtil::GetSelf(Args);
//	
...
//				JsResult->Set(v8::Handle<v8::String>(v8::String::NewFromUtf8(isolate, "U")), JsU);
//				JsResult->Set(v8::Handle<v8::String>(v8::String::NewFromUtf8(isolate, "V")), JsV);
//				JsResult->Set(v8::Handle<v8::String>(v8::String::NewFromUtf8(isolate, "s")), Jss);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::pushV(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TInt, TAuxIntV>::pushV(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsObjUtil<TJsVec>::GetSelf(Args);
//	if (Args[0]->IsObject()) {
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::sortPerm(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsObjUtil<TJsVec>::GetSelf(Args);
//	bool Asc = true;
//	if (Args.Length() > 0) {
...
//	v8::Handle<v8::Object> JsObj = v8::Object::New();
//	v8::Persistent<v8::Object> JsResult = v8::Persistent<v8::Object>::New(v8::Isolate::GetCurrent(), JsObj);
//	JsResult->Set(v8::Handle<v8::String>(v8::String::NewFromUtf8(isolate, "vec")), JsSortedV);
//	JsResult->Set(v8::Handle<v8::String>(v8::String::NewFromUtf8(isolate, "perm")), JsPermV);
//	return HandleScope.Close(JsResult);
//}
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::outer(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::inner(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::plus(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltV* JsFltV =  TJsObjUtil<TJsVec>::GetSelf(Args);
//	if (Args.Length() > 0) {		
//		if (Args[0]->IsObject()) {
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::minus(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltV* JsFltV = TJsObjUtil<TJsVec>::GetSelf(Args);
//	if (Args.Length() > 0) {		
//		if (Args[0]->IsObject()) {
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::multiply(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltV* JsFltV = TJsObjUtil<TJsVec>::GetSelf(Args);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::normalize(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltV* JsFltV = TJsObjUtil<TJsVec>::GetSelf(Args);		
//	if (JsFltV->Vec.Len() > 0) {
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::diag(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltV* JsFltV = TJsObjUtil<TJsVec>::GetSelf(Args);	
//	v8::Persistent<v8::Object> JsResult = TJsFltVV::New(JsFltV->Js);
//	TFltVV& Result = TJsFltVV::GetFltVV(JsResult);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::spDiag(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltV* JsFltV = TJsObjUtil<TJsVec>::GetSelf(Args);	
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::norm(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsObjUtil<TJsVec>::GetSelf(Args);
...
//
//template <>
//v8::Handle<v8::Value> TJsVec<TFlt, TAuxFltV>::sparse(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsVec* JsVec = TJsObjUtil<TJsVec>::GetSelf(Args);
//	TIntFltKdV Res;
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::at(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::put(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);	
//	if (Args.Length() == 3) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::multiply(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::multiplyT(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (TJsFltVVUtil::IsArgFlt(Args, 0)) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::plus(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (Args[0]->IsObject()) {			
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::minus(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (Args[0]->IsObject()) {			
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::transpose(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
//	
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::solve(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {		
//		if (Args[0]->IsObject()) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::rowNorms(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::colNorms(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
//	v8::Persistent<v8::Object> JsResult = TJsFltV::New(JsFltVV->Js);
//	TFltV& Result = TJsFltV::GetVec(JsResult);	
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::normalizeCols(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::sparse(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::frob(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
//	double FrobNorm = 0.0;
//	int Cols = JsFltVV->Mat.GetCols();
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::printStr(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
//	TStr Out = "";
//	TLAMisc::PrintTFltVVToStr(JsFltVV->Mat, Out);
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, Out.CStr()));	
//}
//
//v8::Handle<v8::Value> TJsFltVV::print(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsFltVV = TJsFltVVUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::rowMaxIdx(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::colMaxIdx(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (TJsFltVVUtil::IsArgInt32(Args, 0)) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::getCol(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (TJsFltVVUtil::IsArgInt32(Args, 0)) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::setCol(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 1) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::getRow(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (TJsFltVVUtil::IsArgInt32(Args, 0)) {
...
//}
//
//v8::Handle<v8::Value> TJsFltVV::setRow(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFltVV* JsMat = TJsFltVVUtil::GetSelf(Args);
//	if (Args.Length() > 1) {
//		QmAssertR(Args[1]->IsObject() && TJsFltVVUtil::IsArgClass(Args, 1, "TFltV") && TJsFltVVUtil::IsArgInt32(Args, 0), "arg[0] should be an integer, arg[1] should be a TFltV");
...
//}
//
//v8::Handle<v8::Value> TJsSpV::at(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsSpV::put(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);
//	if (Args.Length() == 2) {
//		QmAssertR(Args[0]->IsInt32(), "the first argument should be an integer");
...
//}
//
//v8::Handle<v8::Value> TJsSpV::sum(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);
//	double result = 0.0;
//	if (JsSpV->Vec.Len() > 0) {
...
//}
//
//v8::Handle<v8::Value> TJsSpV::inner(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);
//	double result = 0.0;
//	if (Args[0]->IsObject()) {
...
//}
//
//v8::Handle<v8::Value> TJsSpV::multiply(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsSpV::normalize(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);		
//	if (JsSpV->Vec.Len() > 0) {
...
//}
//
//v8::Handle<v8::Value> TJsSpV::print(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);		
...
//}
//
//v8::Handle<v8::Value> TJsSpV::norm(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsSpV::full(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpV* JsSpV = TJsSpVUtil::GetSelf(Args);
//	
//	int Len = JsSpV->Dim;
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::at(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::put(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);	
//	if (Args.Length() == 3) {
//		QmAssertR(Args[0]->IsInt32(), "the first argument should be an integer");
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::push(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::multiply(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsMat = TJsSpMatUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::multiplyT(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsMat = TJsSpMatUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (TJsSpMatUtil::IsArgFlt(Args, 0)) {
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::plus(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsMat = TJsSpMatUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (Args[0]->IsObject()) {			
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::minus(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsMat = TJsSpMatUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
//		if (Args[0]->IsObject()) {			
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::transpose(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::colNorms(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::normalizeCols(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::full(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);
//	TFltVV FullMat;
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::frob(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);
//	double FrobNorm = 0.0;
//	int Cols = JsSpMat->Mat.Len();
...
//}
//
//v8::Handle<v8::Value> TJsSpMat::print(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsSpMat* JsSpMat = TJsSpMatUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::newFeatureSpace(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::loadFeatureSpace(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);
//    // parse parameters
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::trainSvmClassify(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::trainSvmRegression(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::loadSvmModel(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);	
//	if (Args.Length() > 0) {
//        PSIn SIn = TJsFIn::GetArgFIn(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::newRecLinReg(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//    TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);
//    PJsonVal ParamVal = TJsAnalyticsUtil::GetArgJson(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::newHoeffdingTree(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//    TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::trainKMeans(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsAnalytics* JsAnalytics = TJsAnalyticsUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsAnalytics::getLanguageOptions(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//PFtrSpace TJsFtrSpace::GetArgFtrSpace(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//    v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we have the argument at all
//    AssertR(Args.Length() > ArgN, TStr::Fmt("Missing argument %d", ArgN));
//    v8::Handle<v8::Value> Val = Args[ArgN];
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::save(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::updateRecord(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::updateRecords(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
//    PRecSet RecSet = TJsRecSet::GetArgRecSet(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::finishUpdate(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//v8::Handle<v8::Value> TJsFtrSpace::extractStrings(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
...
//    for(int StrN = 0; StrN < StrV.Len(); StrN++) {
//		StrArr->Set(v8::Uint32::New(StrN), v8::String::NewFromUtf8(isolate, StrV.GetVal(StrN).CStr()));
//	}
//	return HandleScope.Close(StrArr);
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::ftrSpVec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::ftrVec(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
//    TRec Rec = TJsRec::GetArgRec(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::ftrSpColMat(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
//    PRecSet RecSet = TJsRecSet::GetArgRecSet(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsFtrSpace::ftrColMat(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//	TJsFtrSpace* JsFtrSpace = TJsFtrSpaceUtil::GetSelf(Args);	
//    PRecSet RecSet = TJsRecSet::GetArgRecSet(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsSvmModel::predict(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
...
//}
//
//v8::Handle<v8::Value> TJsSvmModel::save(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	// parse arguments
//	TJsSvmModel* JsSvmModel = TJsSvmModelUtil::GetSelf(Args);
//	if (Args.Length() > 0) {
...
//}
//
//v8::Handle<v8::Value> TJsRecLinRegModel::learn(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
...
//}
//
//v8::Handle<v8::Value> TJsRecLinRegModel::predict(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // parse arguments
//    TJsRecLinRegModel* JsRecLinRegModel = TJsRecLinRegModelUtil::GetSelf(Args);
//    // get feature vector
...
//}
//
//v8::Handle<v8::Value> TJsGeoIp::country(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	// read IP address
...
//	// return
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, CountryNm.CStr()));
//}
//
//v8::Handle<v8::Value> TJsGeoIp::location(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	// read IP address
//	TStr IpNumStr = TJsGeoIpUtil::GetArgStr(Args, 0);
//	QmAssertR(TUInt::IsIpStr(IpNumStr), "Invalid IP address " + IpNumStr);
...
//}
//
//v8::Handle<v8::Value> TJsConsole::log(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	if (Args.Length() == 1) {
...
//}
//
//v8::Handle<v8::Value> TJsConsole::getln(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TStdIn StdIn;
//	TStr LnStr;
//	StdIn.GetNextLn(LnStr);
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, LnStr.CStr()));
//}
//
//v8::Handle<v8::Value> TJsConsole::print(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//bool TJsFs::CanAccess(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//v8::Handle<v8::Value> TJsFs::openRead(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsFs::openWrite(const v8::FunctionCallbackInfo<v8::Value>& Args) { // call withb AppendP = false
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(FNm), "You don't have permission to access file '" + FNm + "'");    
...
//}
//
//v8::Handle<v8::Value> TJsFs::openAppend(const v8::FunctionCallbackInfo<v8::Value>& Args) { // call with AppendP = true 
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(FNm), "You don't have permission to access file '" + FNm + "'");
...
//}
//
//v8::Handle<v8::Value> TJsFs::exists(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(FNm), "You don't have permission to access file '" + FNm + "'");
...
//}
//
//v8::Handle<v8::Value> TJsFs::copy(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
...
//}
//
//v8::Handle<v8::Value> TJsFs::move(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr SrcFNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(SrcFNm), "You don't have permission to access file '" + SrcFNm + "'");
...
//}
//
//v8::Handle<v8::Value> TJsFs::del(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(FNm), "You don't have permission to access file '" + FNm + "'");
...
//}
//
//v8::Handle<v8::Value> TJsFs::rename(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr SrcFNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(SrcFNm), "You don't have permission to access file '" + SrcFNm + "'");
...
//}
//
//v8::Handle<v8::Value> TJsFs::fileInfo(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FNm = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(FNm), "You don't have permission to access file '" + FNm + "'");
...
//	Obj->Set(v8::String::NewFromUtf8(isolate, "createTime"), v8::String::NewFromUtf8(isolate, TTm::GetTmFromMSecs(CreateTm).GetWebLogDateTimeStr().CStr()));
//	Obj->Set(v8::String::NewFromUtf8(isolate, "lastAccessTime"), v8::String::NewFromUtf8(isolate, TTm::GetTmFromMSecs(LastAccessTm).GetWebLogDateTimeStr().CStr()));
//	Obj->Set(v8::String::NewFromUtf8(isolate, "lastWriteTime"), v8::String::NewFromUtf8(isolate, TTm::GetTmFromMSecs(LastWriteTm).GetWebLogDateTimeStr().CStr()));
//	Obj->Set(v8::String::NewFromUtf8(isolate, "size"), v8::Number::New(static_cast<double>(Size)));
//	return HandleScope.Close(Obj);
//}
//
//v8::Handle<v8::Value> TJsFs::mkdir(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FPath = TJsFsUtil::GetArgStr(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsFs::rmdir(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    TStr FPath = TJsFsUtil::GetArgStr(Args, 0);
//    QmAssertR(JsFs->CanAccess(FPath), "You don't have permission to access directory '" + FPath + "'");
...
//}
//
//v8::Handle<v8::Value> TJsFs::listFile(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFs* JsFs = TJsFsUtil::GetSelf(Args);
//    // read parameters
//    TStr FPath = TJsFsUtil::GetArgStr(Args, 0);
...
//		FNmArr->Set(v8::Uint32::New(FldN), v8::String::NewFromUtf8(isolate, FNmV.GetVal(FldN).CStr()));
//	}
...
//PSIn TJsFIn::GetArgFIn(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//    v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we have the argument at all
//    AssertR(Args.Length() > ArgN, TStr::Fmt("Missing argument %d", ArgN));
//    v8::Handle<v8::Value> Val = Args[ArgN];
...
//
//// takes no arguments 
//v8::Handle<v8::Value> TJsFIn::getCh(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFIn* JsFIn = TJsFInUtil::GetSelf(Args);
//	return v8::String::NewFromUtf8(isolate, TStr(JsFIn->SIn->GetCh()).CStr());
//}
//
//v8::Handle<v8::Value> TJsFIn::peekCh(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFIn* JsFIn = TJsFInUtil::GetSelf(Args);
//	return v8::String::NewFromUtf8(isolate, TStr(JsFIn->SIn->PeekCh()).CStr());
//}
//
//v8::Handle<v8::Value> TJsFIn::readLine(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFIn* JsFIn = TJsFInUtil::GetSelf(Args);
//	TChA LnChA; JsFIn->SIn->GetNextLn(LnChA);
//	return v8::String::NewFromUtf8(isolate, LnChA.CStr());
//}
//
...
//PSOut TJsFOut::GetArgFOut(const v8::FunctionCallbackInfo<v8::Value>& Args, const int& ArgN) {
//    v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we have the argument at all
//    AssertR(Args.Length() > ArgN, TStr::Fmt("Missing argument %d", ArgN));
//    v8::Handle<v8::Value> Val = Args[ArgN];
...
//}
//
//v8::Handle<v8::Value> TJsFOut::write(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsFOut::writeLine(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // first we write
...
//}
//
//v8::Handle<v8::Value> TJsFOut::flush(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFOut* JsFOut = TJsFOutUtil::GetSelf(Args);
//    QmAssertR(!JsFOut->SOut.Empty(), "Output stream already closed!");
//	JsFOut->SOut->Flush();
...
//}
//
//v8::Handle<v8::Value> TJsFOut::close(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsFOut* JsFOut = TJsFOutUtil::GetSelf(Args);
//	JsFOut->SOut.Clr();
//	return v8::Undefined();
...
//}
//
//v8::Handle<v8::Value> TJsHttp::onRequest(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsHttp::get(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsHttp* JsHttp = TJsHttpUtil::GetSelf(Args);
//	// get function name and callback
...
//}
//
//v8::Handle<v8::Value> TJsHttp::post(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsHttp* JsHttp = TJsHttpUtil::GetSelf(Args);
//	// get function name and callback
//	TStr UrlStr = TJsHttpUtil::GetArgStr(Args, 0);
...
//v8::Handle<v8::Value> TJsHttpResp::setStatusCode(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//
////TODO change to property
//v8::Handle<v8::Value> TJsHttpResp::setContentType(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we are still allowed to do anything    
//    TJsHttpResp* JsHttpResp = TJsHttpRespUtil::GetSelf(Args);
//    QmAssertR(!JsHttpResp->DoneP, "HTTP response already completed.");
...
//}
//
//v8::Handle<v8::Value> TJsHttpResp::add(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we are still allowed to do anything    
//    TJsHttpResp* JsHttpResp = TJsHttpRespUtil::GetSelf(Args);
//    QmAssertR(!JsHttpResp->DoneP, "HTTP response already completed.");
...
//}
//
//v8::Handle<v8::Value> TJsHttpResp::close(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//    // check we are still allowed to do anything    
//    TJsHttpResp* JsHttpResp = TJsHttpRespUtil::GetSelf(Args);
//    QmAssertR(!JsHttpResp->DoneP, "HTTP response already completed.");
...
//}
//
//v8::Handle<v8::Value> TJsHttpResp::send(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, TmStr.CStr()));
//}
//
...
//	return HandleScope.Close(v8::String::NewFromUtf8(isolate, SecTm.GetDayOfWeekNm().CStr()));
//}
//
...
//}
//
//v8::Handle<v8::Value> TJsTm::add(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
...
//}
//
//v8::Handle<v8::Value> TJsTm::sub(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsTm* JsTm = TJsTmUtil::GetSelf(Args);   
//    // parse arguments
//    const int Val = TJsTmUtil::GetArgInt32(Args, 0);
...
//}
//
//v8::Handle<v8::Value> TJsTm::toJSON(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
//	TJsTm* JsTm = TJsTmUtil::GetSelf(Args);   
//    // prepare response object
//    v8::Local<v8::Object> TmJson = v8::Object::New();
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "year"), v8::Int32::New(JsTm->Tm.GetYear()));
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "month"), v8::Int32::New(JsTm->Tm.GetMonth()));
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "day"), v8::Int32::New(JsTm->Tm.GetDay()));
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "hour"), v8::Int32::New(JsTm->Tm.GetHour()));
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "minute"), v8::Int32::New(JsTm->Tm.GetMin()));
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "second"), v8::Int32::New(JsTm->Tm.GetSec()));
//    TmJson->Set(v8::String::NewFromUtf8(isolate, "milisecond"), v8::Int32::New(JsTm->Tm.GetMSec()));
//    // return constructed json
//    return HandleScope.Close(TmJson);
//}
//
//v8::Handle<v8::Value> TJsTm::parse(const v8::FunctionCallbackInfo<v8::Value>& Args) {
//	v8::Isolate* isolate = v8::Isolate::GetCurrent();v8::HandleScope HandleScope(isolate);
